...
var _user$project$Main$getCell = F2(
	function (cells, _p0) {
		...
		return A2(
			...
			_elm_lang$core$Array$get(_p1._0),
			A2(_elm_lang$core$Array$get, _p1._1, cells));
	});
var _user$project$Main$getNeighbors = F2(
	function (cells, _p2) {
		...
		var nPoss = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _p4 - 1, _1: _p5 - 1},
			_1: {
				ctor: '::',
		...
		return _elm_community$maybe_extra$Maybe_Extra$values(
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$getCell(cells),
				nPoss));
	});
var _user$project$Main$viewCell = F2(
	function (pxls, cell) {
		...
		var pixels = A2(
			...
			_elm_lang$core$Basics$toString(pxls),
			'px');
		return A2(
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'width', _1: pixels},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'height', _1: pixels},
								_1: {
									ctor: '::',
			...
			A2(
				...
				_elm_lang$core$Array$toList(
					A2(
						...
						_user$project$Main$viewCell(pxls),
						cells)),
				{
					ctor: '::',
					_0: A2(
...
var _user$project$Main$view = function (model) {
	var pxls = (800 / _elm_lang$core$Array$length(model)) | 0;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		_elm_lang$core$Array$toList(
			A2(
				_elm_lang$core$Array$map,
				_user$project$Main$viewRow(pxls),
				model)));
};
var _user$project$Main$CellStat = F2(
	function (a, b) {
		return {aliveNeighbors: a, deadNeighbors: b};
	});
var _user$project$Main$Dead = {ctor: 'Dead'};
var _user$project$Main$emptyModel = F2(
	function (w, h) {
		var row = function (_p7) {
			return A2(
				_elm_lang$core$Array$initialize,
				w,
				_elm_lang$core$Basics$always(_user$project$Main$Dead));
		};
		return A2(_elm_lang$core$Array$initialize, h, row);
	});
var _user$project$Main$Alive = {ctor: 'Alive'};
var _user$project$Main$getCellStat = F2(
	function (cells, _p8) {
		var _p9 = _p8;
		var alive = _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				function (c) {
					return _elm_lang$core$Native_Utils.eq(c, _user$project$Main$Alive);
				},
				A2(
					_user$project$Main$getNeighbors,
					cells,
					{ctor: '_Tuple2', _0: _p9._0, _1: _p9._1})));
		var dead = 8 - alive;
		return A2(_user$project$Main$CellStat, alive, dead);
	});
var _user$project$Main$iterate = function (model) {
	var iterateCell = F2(
		function (_p10, cell) {
			var _p11 = _p10;
			var cellStat = A2(
				_user$project$Main$getCellStat,
				model,
				{ctor: '_Tuple2', _0: _p11._0, _1: _p11._1});
			var _p12 = cell;
			if (_p12.ctor === 'Dead') {
				return _elm_lang$core$Native_Utils.eq(cellStat.aliveNeighbors, 3) ? _user$project$Main$Alive : _user$project$Main$Dead;
			} else {
				return (_elm_lang$core$Native_Utils.cmp(cellStat.aliveNeighbors, 2) < 0) ? _user$project$Main$Dead : ((_elm_lang$core$Native_Utils.cmp(cellStat.aliveNeighbors, 3) < 1) ? _user$project$Main$Alive : _user$project$Main$Dead);
			}
		});
	var iterateRow = function (y) {
	...
	return A2(_elm_lang$core$Array$indexedMap, iterateRow, model);
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p13 = msg;
		if (_p13.ctor === 'SetModel') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_p13._0,
				{ctor: '[]'});
			...
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_user$project$Main$iterate(model),
				{ctor: '[]'});
		}
	});
var _user$project$Main$randomCell = _elm_community$random_extra$Random_Extra$frequency(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 0.1,
			_1: _elm_community$random_extra$Random_Extra$constant(_user$project$Main$Alive)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 0.9,
				_1: _elm_community$random_extra$Random_Extra$constant(_user$project$Main$Dead)
			},
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$randomRow = function (n) {
	return A2(_elm_community$random_extra$Random_Array$array, n, _user$project$Main$randomCell);
};
var _user$project$Main$randomRows = F2(
	function (w, h) {
		return A2(
			_elm_community$random_extra$Random_Array$array,
			h,
			_user$project$Main$randomRow(w));
	});
var _user$project$Main$SetModel = function (a) {
	return {ctor: 'SetModel', _0: a};
};
var _user$project$Main$randomModel = F2(
	function (w, h) {
		return A2(
			_elm_lang$core$Random$generate,
			_user$project$Main$SetModel,
			A2(_user$project$Main$randomRows, w, h));
	});
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			A2(_user$project$Main$emptyModel, 0, 0),
			{
				ctor: '::',
				_0: A2(_user$project$Main$randomModel, 100, 80),
				_1: {ctor: '[]'}
			}),
		update: _user$project$Main$update,
		view: _user$project$Main$view,
		subscriptions: _elm_lang$core$Basics$always(
			A2(_elm_lang$core$Time$every, 100 * _elm_lang$core$Time$millisecond, _user$project$Main$Tick))
	})();
